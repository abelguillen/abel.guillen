...
public class Ejercicio4 {
	...
	private static void informacion(List<Integer> lista1, Integer numero) {
		...
		//Rta: 
		//- La primer salida retorna un contador de los numeros pares.
		//- La segunda salida retorna una lista con los numeros impares.
		//- La tercer salida retorna el indice en la lista del elemento asignado. En este caso P vale 5.
		//  Con lo cual, se devuelve el valor 2 segun lista: {1, 2, 5, 8, 10, 30, 20, 8, 9, 10}
		//- La cuarta salida devuelve "..." al ingresar a "else if (c > 0)" debido a que el resultado de la
		//  operacion realizada en el for es = 2. Por lo tanto, cumple con la condicion establecida en el if.
	...
	private static List<Integer> unionListas(List<Integer> lista1, List<Integer> lista2) {
		...
		// Correccion: Modificar " union.addAll(lista1); " por " union = lista1; "
	...
	private static List<Integer> interseccionListas(List<Integer> lista1, List<Integer> lista2) {
		// TODO: Implementacion
		List<Integer> interseccionListas = new ArrayList<Integer>();
		List<Integer> unionListas = unionListas(lista1, lista2);
		
		for (Integer m: unionListas) {
			if (!interseccionListas.contains(m)) {
				interseccionListas.add(m);
			}
		}
	...
	private static List<Integer> ordenaListaAscendente(List<Integer> lista1) {
		// TODO: Ordeno mediante el metodo "sort" de "Collections"
